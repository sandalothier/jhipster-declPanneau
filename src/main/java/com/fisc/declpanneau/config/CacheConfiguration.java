package com.fisc.declpanneau.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("declPanneau");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("declPanneau");
        ...
        config.getMapConfigs().put("com.fisc.declpanneau.domain.*", initializeDomainMapConfig(jHipsterProperties));
