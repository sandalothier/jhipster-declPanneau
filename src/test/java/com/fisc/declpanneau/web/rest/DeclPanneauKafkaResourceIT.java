...
import com.fisc.declpanneau.DeclPanneauApp;
...
@SpringBootTest(classes = DeclPanneauApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DeclPanneauKafkaResourceIT {
    ...
    @Autowired
    private DeclPanneauKafkaProducer producer;

    @Autowired
    private DeclPanneauKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclPanneauKafkaResource kafkaResource = new DeclPanneauKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decl-panneau-kafka/publish?message=test"))
